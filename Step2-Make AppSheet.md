...
1. [ภาพรวมระบบ](#section-1)
2.  [เตรียม Google Sheets](#section-2)
3.  [เชื่อม Google Sheets กับ AppSheet](#section-3)
4.  [สร้างความสัมพันธ์ระหว่างตาราง](#section-4)
5.  [คำนวณราคาของแต่ละเมนู](#section-5)
6.  [คำนวณยอดรวม Order](#section-6)
7.  [สร้างหน้า Menu](#section-7)
8.  [สร้าง Order Form](#section-8)
9.  [เลือกเฉพาะโต๊ะที่ว่าง](#section-9)
10. [เปลี่ยนโต๊ะเป็นไม่ว่างเมื่อรับ Order](#section-10)
11. [สร้าง Active Orders](#section-11)
12. [สร้างหน้า KITCHEN & PAYMENT](#section-12)
13. [สร้าง Dropdown สถานะ Order](#section-13)
14. [ให้แก้สถานะจากหน้า Detail](#section-14)
15. [สร้างปุ่ม "ชำระเงิน"](#section-15)
16. [Workflow การชำระเงิน](#section-16)
17. [การทำงานจริงของพนักงาน](#section-17)
18. [สรุป Data Flow](#section-18)
...
`<a id="section-1">`{=html}`</a>`{=html} /## 1. ภาพรวมระบบ
...
`<a id="section-2">`{=html}`</a>`{=html} \# 2. เตรียม Google Sheets
...
`<a id="section-3">`{=html}`</a>`{=html} \# 3. เชื่อม Google Sheets กับ
AppSheet
...
`<a id="section-4">`{=html}`</a>`{=html} \# 4. สร้างความสัมพันธ์ระหว่างตาราง
...
`<a id="section-5">`{=html}`</a>`{=html} \# 5. คำนวณราคาของแต่ละเมนู
...
`<a id="section-6">`{=html}`</a>`{=html} \# 6. คำนวณยอดรวม Order
...
`<a id="section-7">`{=html}`</a>`{=html} \# 7. สร้างหน้า Menu
...
`<a id="section-8">`{=html}`</a>`{=html} \# 8. สร้าง Order Form
...
`<a id="section-9">`{=html}`</a>`{=html} \# 9. เลือกเฉพาะโต๊ะที่ว่าง
...
`<a id="section-10">`{=html}`</a>`{=html} \# 10. เปลี่ยนโต๊ะเป็นไม่ว่างเมื่อรับ
Order
...
`<a id="section-11">`{=html}`</a>`{=html} \# 11. สร้าง Active Orders
...
`<a id="section-12">`{=html}`</a>`{=html} \# 12. สร้างหน้า KITCHEN &
PAYMENT
...
`<a id="section-13">`{=html}`</a>`{=html} \# 13. สร้าง Dropdown สถานะ
Order
...
`<a id="section-14">`{=html}`</a>`{=html} \# 14. ให้แก้สถานะจากหน้า Detail
...
`<a id="section-15">`{=html}`</a>`{=html} \# 15. สร้างปุ่ม "ชำระเงิน"
...
`<a id="section-16">`{=html}`</a>`{=html} \# 16. Workflow การชำระเงิน
...
`<a id="section-17">`{=html}`</a>`{=html} \# 17. การทำงานจริงของพนักงาน
...
`<a id="section-18">`{=html}`</a>`{=html} \# 18. สรุป Data Flow
...
`<a id="section-19">`{=html}`</a>`{=html} \# 19. Business Process
ที่ระบบรองรับ
...
`<a id="section-20">`{=html}`</a>`{=html} \# 20. Checklist ก่อนใช้งานจริง
